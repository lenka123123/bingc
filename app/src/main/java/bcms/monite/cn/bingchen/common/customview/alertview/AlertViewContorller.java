 ...
 */
public class AlertViewContorller {
    ...
    private ViewGroup rootView;//AlertViewContorller 的 根View
     ...
     */
    public AlertViewContorller(View view, String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style, OnItemClickListener onItemClickListener) {
        this.context = context;
        if (style != null) this.style = style;
        this.onItemClickListener = onItemClickListener;

        initData(view, title, msg, cancel, destructive, others);//初始化数据
        initViews();//初始化控件及样式
        init();//动画
        initEvents();//添加view
    }
     ...
     * 获取数据
     */
    protected void initData(View view, String title, String msg, String cancel, String[] destructive, String[] others) {
    ...
    protected void initViews() {
        ...
        switch (style) {
            case ActionSheet:
                ...
                params.setMargins(margin_alert_left_right, 800, margin_alert_left_right, margin_alert_left_right);
        ...
        alertButtonListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if (onItemClickListener != null)
                    onItemClickListener.onItemClick(mtextview, mOthers, AlertViewContorller.this, position);
                dismiss();
            }
        });
    }
     ...
     * @return
     */
    public AlertViewContorller addExtView(View extView) {
...
//            return;
                ...
                decorView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (onDismissListener != null) {
                            onDismissListener.onDismiss(AlertViewContorller.this);
                        }
                    }
                });
            }
    ...
    public AlertViewContorller setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    public AlertViewContorller setCancelable(boolean isCancelable) {
